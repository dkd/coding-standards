 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class DkdCollection_Sniffs_NamingConventions_UpperCaseConstantNameSniff implements PHP_CodeSniffer_Sniff {


	protected $_DkdCollectionConstants = array(
		'TYPO3_OS',
		'TYPO3_MODE',
		'PATH_thisScript',
		'TYPO3_mainDir',
	...
	public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr) {
		...
		if ($tokens[$openBracket]['code'] !== T_OPEN_PARENTHESIS) {
			...
			if (strtoupper($constName) !== $constName && !in_array($constName, $this->_DkdCollectionConstants)) {
